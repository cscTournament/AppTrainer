            ...
            <div class="col-md-10 col-md-offset-0">
                <table class="table table-condensed table-bordered">
                    <tr class="active">
                        ...
                        <td align="center" style="border-color: #8381eb"><fmt:message key="table.rent.web_shop"/></td>
                    ...
                    <c:forEach items="${appsList}" varStatus="сounter" end="6">
                        <tr class="active">
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${appsList[сounter.count-1].id}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${appsList[сounter.count-1].type}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${appsList[сounter.count-1].pricePerHour}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${appsList[сounter.count-1].city}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb">${appsList[сounter.count-1].location}</td>
                            <td align="center" style="vertical-align: middle; border-color: #8381eb"><img src="data:image/jpeg;base64,${appsList[сounter.count-1].picture}"/>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
